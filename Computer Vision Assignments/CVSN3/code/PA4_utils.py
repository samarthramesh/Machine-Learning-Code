...
def plotconfmat(classifier, test_image_feats, test_labels, predicted_categories, categories, abbr_categories):
  ...
  disp = plot_confusion_matrix(classifier, test_image_feats, test_labels, display_labels=abbr_categories, cmap=plt.cm.Blues, normalize='true')
  disp.ax_.set_title('Confusion matrix. Mean of diagonal = {:4.2f}%'.format(acc*100))
  plt.show()