...
def parseOptions():
    ...
    optParser.add_option('-a', '--agent',action='store', metavar="A",
                         ...
                         help='Agent type (options are \'random\', \'value\', \'q\' and \'RMax\', default %default)')
    ...
    optParser.add_option('-M', '--vcount',action='store',
                         type='int',dest='vcount',default=10,
                         metavar="visit count", 
                         help='Min number of times you need to perform all actions from the state to make the ' \
                                'state known  (default %default)')
...
if __name__ == '__main__':
    ...
    import valueIterationAgents, qlearningAgents, qlearningAgent_rmax
    a = None
    if opts.agent == 'value':
        ...
        qLearnOpts = {'gamma': opts.discount,
                      'm': opts.vcount,
                      'actionFn': actionFn}
        a = qlearningAgent_rmax.QLearningAgentRMax(**qLearnOpts)
